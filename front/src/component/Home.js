              ...
              <div className="header-content">
                <div className="overlay">
                  <div className="header-content-item">
                    ...
                    <a href="#" className="link" data-bs-toggle="modal" data-bs-target="#freeSpotsModal" onClick={handleViewFreeSpots}>VIEW FREE SPOTS</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <video controls width="100%">
                <source src="http://localhost:5001/video_feed" type="video/mp4" />
